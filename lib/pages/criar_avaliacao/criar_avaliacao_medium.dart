          ...
          Container(
            ...
            child: Padding(
              ...
              child: DropdownButton2(
                items: _tiposAvaliacao.map((ta) => DropdownMenuItem<String>(
                  value: ta,
                  child: Text(ta),
                )).toList(),
                onChanged: (value) {
        ...
        children: [
          ...
          Container(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: DropdownButton2(
                items: _metodosEntrega.map((me) => DropdownMenuItem<String>(
                  value: me,
                  child: Text(me),
                )).toList(),
                onChanged: (value) {
  ...
  Container buildDescricaoAvaliacao() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Descrição da avaliação (opcional):', style: TextStyle(color: Colors.black, fontSize: 20)),
          SizedBox(height: 10),
          TextField(
            maxLines: null,
            maxLength: 400,
